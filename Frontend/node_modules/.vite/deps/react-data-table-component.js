...
var Te = function() {
  function e2(e3, n, o2) {
    ...
    var r3 = this;
    this.options = __assign(__assign({}, Re), e3), this.gs = n, this.names = new Map(o2), this.server = !!e3.isServer, !this.server && S && De && (De = false, function(e4) {
  ...
  return e2.registerId = function(e3) {
    ...
    return this.tag || (this.tag = (e3 = function(e4) {
      ...
      return e4.isServer ? new Oe(n) : t2 ? new Ie(n) : new Ae(n);
...
function Ve(e2) {
  ...
  u3.push(function(e3) {
    e3.type === RULESET && e3.value.includes("&") && (e3.props[0] = e3.props[0].replace(ke, n).replace(o2, l3));
  ...
  var p3 = function(e3, r4, s4, a3) {
    ...
    var c4 = e3.replace(je, ""), l4 = compile(s4 || r4 ? "".concat(s4, " ").concat(r4, " { ").concat(c4, " }") : c4);
    i3.namespace && (l4 = xe(l4, i3.namespace));
    var p4 = [];
...
function Ge(e2) {
  var t2 = (0, import_react.useState)(e2.stylisPlugins), n = t2[0], r3 = t2[1], c3 = Le().styleSheet, l3 = (0, import_react.useMemo)(function() {
    var t3 = c3;
    return e2.sheet ? t3 = e2.sheet : e2.target && (t3 = t3.reconstructWithOptions({ target: e2.target }, false)), e2.disableCSSOMInjection && (t3 = t3.reconstructWithOptions({ useCSSOMInjection: false })), t3;
  }, [e2.disableCSSOMInjection, e2.sheet, e2.target, c3]), u3 = (0, import_react.useMemo)(function() {
    return Ve({ options: { namespace: e2.namespace, prefix: e2.enableVendorPrefixes }, plugins: n });
...
var Ue = function(t2) {
  ...
  for (var s3 in t2) {
    var i3 = t2[s3];
    t2.hasOwnProperty(s3) && !He(i3) && (Array.isArray(i3) && i3.isCss || re(i3) ? r3.push("".concat(qe(s3), ":"), i3, ";") : ce(i3) ? r3.push.apply(r3, __spreadArray(__spreadArray(["".concat(s3, " {")], Ue(i3), false), ["}"], false)) : r3.push("".concat(qe(s3), ": ").concat((n = s3, null == (o2 = i3) || "boolean" == typeof o2 || "" === o2 ? "" : "number" != typeof o2 || 0 === o2 || n in unitlessKeys || n.startsWith("--") ? String(o2).trim() : "".concat(o2, "px")), ";")));
  }
  return r3;
};
function Je(e2, t2, n, o2) {
  if (He(e2))
    return [];
  if (se(e2))
  ...
  if (re(e2)) {
    if (!re(s3 = e2) || s3.prototype && s3.prototype.isReactComponent || !t2)
      return [e2];
    var r3 = e2(t2);
    return "object" != typeof r3 || Array.isArray(r3) || r3 instanceof Ye || ce(r3) || null === r3 || console.error("".concat(B(e2), " is not a styled component and cannot be referred to via component selector. See https://www.styled-components.com/docs/advanced#referring-to-other-components for more details.")), Je(r3, t2, n, o2);
  }
  var s3;
  return e2 instanceof Ye ? n ? (e2.inject(n, o2), [e2.getName(o2)]) : [e2] : ce(e2) ? Ue(e2) : Array.isArray(e2) ? Array.prototype.concat.apply(_, e2.map(function(e3) {
    return Je(e3, t2, n, o2);
  })) : [e2.toString()];
}
function Xe(e2) {
...
var Ke = function() {
  function e2(e3, t2, n) {
    this.rules = e3, this.staticRulesId = "", this.isStatic = false, this.componentId = t2, this.baseHash = M(Ze, t2), this.baseStyle = n, Te.registerId(t2);
  }
  return e2.prototype.generateAndInjectStyles = function(e3, t2, n) {
    ...
    if (this.isStatic && !n.hash)
      if (this.staticRulesId && t2.hasNameForId(this.componentId, this.staticRulesId))
        ...
        var r3 = ae(Je(this.rules, e3, t2, n)), s3 = x(M(this.baseHash, r3) >>> 0);
...
var et = Qe.Consumer;
function nt(e2) {
  var n = import_react.default.useContext(Qe), r3 = (0, import_react.useMemo)(function() {
  ...
  return e2.children ? import_react.default.createElement(Qe.Provider, { value: r3 }, e2.children) : null;
}
var ot = {};
...
function st(e2, r3, s3) {
  ...
  var N3 = new Ke(s3, g3, i3 ? a2.componentStyle : void 0);
  function O3(e3, r4) {
    return function(e4, r5, s4) {
      var i4 = e4.attrs, a3 = e4.componentStyle, c4 = e4.defaultProps, p4 = e4.foldedComponentIds, d3 = e4.styledComponentId, h3 = e4.target, f4 = import_react.default.useContext(Qe), m4 = Le(), y4 = e4.shouldForwardProp || m4.shouldForwardProp;
...
function ct(t2) {
  for (var n = [], o2 = 1; o2 < arguments.length; o2++)
    n[o2 - 1] = arguments[o2];
  if (re(t2) || ce(t2))
    return at(Je(it(_, __spreadArray([t2], n, true))));
  var r3 = t2;
...
function lt(n, o2, r3) {
  ...
  var s3 = function(t2) {
    ...
    return n(o2, r3, ct.apply(void 0, __spreadArray([t2], s4, false)));
  };
  return s3.attrs = function(e2) {
    return lt(n, o2, __assign(__assign({}, r3), { attrs: Array.prototype.concat(r3.attrs, e2).filter(Boolean) }));
  }, s3.withConfig = function(e2) {
    return lt(n, o2, __assign(__assign({}, r3), e2));
  }, s3;
}
var ut = function(e2) {
  return lt(st, e2);
...
var dt = function() {
  ...
  return e2.prototype.createStyles = function(e3, t2, n, o2) {
    var r3 = o2(ae(Je(this.rules, t2, n, o2)), ""), s3 = this.componentId + e3;
    ...
    e3 > 2 && Te.registerId(this.componentId + e3), this.removeStyles(e3, n), this.createStyles(e3, t2, n, o2);
  }, e2;
}();
var yt = function() {
  function e2() {
    ...
    this._emitSheetCSS = function() {
      var t2 = e3.instance.toString(), n = _e(), o2 = ae([n && 'nonce="'.concat(n, '"'), "".concat(f, '="true"'), "".concat(y, '="').concat(v, '"')].filter(Boolean), " ");
      ...
      if (e3.sealed)
        throw he(2);
      var r3 = ((n = {})[f] = "", n[y] = v, n.dangerouslySetInnerHTML = { __html: e3.instance.toString() }, n), s3 = _e();
...
`;
var D2 = pt(k2).attrs((e2) => ({ style: e2.style }))`
...
`;
var K2 = pt.div.attrs((e2) => ({ style: e2.style }))`
	display: flex;
	align-items: stretch;
...
var xe2 = pt.div`
	...
	${({ $responsive: e2, $fixedHeader: t2 }) => e2 && ct`
			overflow-x: auto;
	...
	${({ $fixedHeader: e2 = false, $fixedHeaderScrollHeight: t2 = "100vh" }) => e2 && ct`
			max-height: ${t2};
...
var Xe2 = e.memo(function(t2) {
  ...
  }))))), St && e.createElement("div", null, e.createElement(Et, { onChangePage: Lt, onChangeRowsPerPage: At, rowCount: A3 || kt.length, currentPage: pt2, rowsPerPage: ut2, direction: et2, paginationRowsPerPageOptions: W3, paginationIconLastPage: B3, paginationIconFirstPage: G3, paginationIconNext: V3, paginationIconPrevious: U3, paginationComponentOptions: K3 })));
});
export {
  G2 as Alignment,
  B2 as Direction,
